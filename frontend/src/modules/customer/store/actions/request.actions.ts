...
export const setSelectedModels = createAction('[CUSTOMER] SET_SELECTED_MODELS')<IPriceTypes[]>();
export const cleanPriceList = createAction('[CUSTOMER] CLEAN_PRICE_LIST')();

export const putModelInOrder = createAction('[CUSTOMER] PUT_MODEL_IN_ORDER')<IPriceTypesCount | undefined>();
export const deleteModelInOrder = createAction('[CUSTOMER] DELETE_MODEL_IN_ORDER')<IPriceTypesCount[]>();
export const updateModelInOrder = createAction('[CUSTOMER] UPDATE_MODEL_IN_ORDER')<IPriceTypesCount[]>();
