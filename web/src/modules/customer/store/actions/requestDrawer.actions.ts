...
export const setCustomerError = createAction('[CUSTOMER] SET_DRAWER_CUSTOMER_ERROR')<boolean>();
export const setCityError = createAction('[CUSTOMER] SET_DRAWER_CITY_ERROR')<boolean>();
export const setCommentError = createAction('[CUSTOMER] SET_DRAWER_COMMENT_ERROR')<boolean>();
